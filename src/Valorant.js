  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setLenPlayers(response.data.valorant.length);
      });
  }, []);
  ...
  for (let i = 0; i < lenPlayers; i++) {
    owlSlides.push(
      <div key={`slide-${i}`}>
        <div
          className="bg-image"
          style={{ backgroundImage: `url(${players.valorant[i].image})` }}
        ></div>
        <div className="metadata">
          <h3 className="username">{players.valorant[i].username}</h3>
          <a
            href={`https://www.twitch.tv/${players.valorant[i].username}`}
            target="_blank"
          >
            <svg
        ...
        <div className="tabs-elo">
          ...
          >
            ...
            <Tab eventKey="elo-alto" title="HIGH">
              <iframe
                src="https://challonge.com/es/finzpnm/module"
                width="100%"
                height="500"
                frameborder="0"
                scrolling="auto"
            ...
            <Tab eventKey="elo-bajo" title="LOW">
              <iframe
                src="https://challonge.com/es/rcc4zs94/module"
                width="100%"
                height="500"
                frameborder="0"
                scrolling="auto"
